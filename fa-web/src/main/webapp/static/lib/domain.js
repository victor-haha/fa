	...
	var a = layui.jquery,
		...
		P = {
			...
			theme: function(e) {
				var t = (n.theme, layui.data(n.tableName)),
					...
					r = i([".layui-side-menu,", ".layadmin-pagetabs .layui-tab-title li:after,",
						".layadmin-pagetabs .layui-tab-title li.layui-this:after,", ".layui-layer-domain .layui-layer-title,",
						...
						".layui-layout-domain .layui-logo{background-color:{{d.color.logo || d.color.main}} !important;}",
						"{{# if(d.color.header){ }}", ".layui-layout-domain .layui-header{background-color:{{ d.color.header }};}",
						".layui-layout-domain .layui-header a,", ".layui-layout-domain .layui-header a cite{color: #f8f8f8;}",
						".layui-layout-domain .layui-header a:hover{color: #fff;}",
						".layui-layout-domain .layui-header .layui-nav .layui-nav-more{border-top-color: #fbfbfb;}",
						".layui-layout-domain .layui-header .layui-nav .layui-nav-mored{border-color: transparent; border-bottom-color: #fbfbfb;}",
						".layui-layout-domain .layui-header .layui-nav .layui-this:after, .layui-layout-domain .layui-header .layui-nav-bar{background-color: #fff; background-color: rgba(255,255,255,.5);}",
			...
			resize: function(e) {
				var a = layui.router(),
					i = a.path.join("-");
				P.resizeFn[i] && (r.off("resize", P.resizeFn[i]), delete P.resizeFn[i]), "off" !== e && (e(), P.resizeFn[i] = e,
